...
def listener(): 
    ...
    sub_left = rospy.Subscriber('/wheel_command_left', Float32, set_wheel_command_left) 
    
    #### CODE HERE ####
    sub_right = rospy.Subscriber('/wheel_command_right', Float32, set_wheel_command_right)
    #### END CODE ####
