...
def talker_for_servo_commands():
    ...
    pub_servo_command_0 = rospy.Publisher('/servo_command_0',Float32,queue_size=1)
    ...
    while not rospy.is_shutdown(): 
        ...
        servo_command_0= float(input('Enter servo command 0 angle (roughly -90 to 90 degrees) \n'))
