...
from easel_transform import aruco_marker_world_transform, aruco_marker_world_pos, apply_transform
...
def main():
    ...
    # marker_position = aruco_marker_world_pos(target_id=aruco_marker_id, num_samples=aruco_marker_averaging_samples).marker_position

    # Construct a transformation matrix to go from world-space to easel-space based on the marker's position
    easel_transform = aruco_marker_world_transform(None, camera_pitch, camera_pos_world)
