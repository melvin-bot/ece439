...
def main(): 
    ...
    sub_servo_command_0 = rospy.Subscriber('/servo_command_0', Float32, command_servo_0)
...
def command_servo_0(msg_in): 
    ...
    # convert degrees to us
    cmd_0_us = servos.interp_servo([-90, 90], [500, 2500], cmd_0)
    
    # Send command to servo driver
    servos.command_servo(0,int(cmd_0_us))
